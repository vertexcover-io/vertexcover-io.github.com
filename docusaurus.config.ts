  ...
  plugins: [
    ...
    [
      '@docusaurus/plugin-content-blog',
      {
        ...
        blogTitle: 'Tools',
        blogDescription: 'LLM-built utilities — small, single-purpose, every line written by a coding agent.',
        blogSidebarTitle: 'All tools',
    ...
    //   {
    //     id: 'explorations',
    //     routeBasePath: 'explorations',
    //     path: './explorations',
    //     authorsMapPath: '../blog/authors.yml',
    //     blogTitle: 'Explorations',
    //     blogDescription: 'Curiosities and investigations — short writeups from poking at things, not formal research.',
    //     blogSidebarTitle: 'All explorations',
    //     blogSidebarCount: 'ALL',
    //     showReadingTime: true,
    //     onInlineTags: 'warn',
    //     onInlineAuthors: 'warn',
